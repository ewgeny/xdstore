...
public class XdStorageUpdateLinksByTransactionSQLBuilder extends XdStorageAbstractSQLBuilder {
    ...
    private String build(final XdStorageClassInfo clInfo, final String table) {
        ...
        sb.append("UPDATE ").append(table).append(" SET txname = NULL WHERE txname = ? AND ");
