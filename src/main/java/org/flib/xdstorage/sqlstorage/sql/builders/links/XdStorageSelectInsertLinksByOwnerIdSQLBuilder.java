...
public class XdStorageSelectInsertLinksByOwnerIdSQLBuilder extends XdStorageAbstractSQLBuilder {
    ...
    private String buildSQLId(final String table) {
        return XdStorageSQLBuilderName.SelectInsertLinksByOwnerId.name() + table;
    }

    private String build(final XdStorageClassInfo clOwnerInfo, final String table, final String prevStateTable, final String fieldName,
                         final Class<?>[] classes) {
