...
public class XdStorageInsertIndexForUpdateSQLBuilder extends XdStorageAbstractSQLBuilder {
    ...
    private String buildSQLId(final String table) {
        return XdStorageSQLBuilderName.InsertIndexForUpdate.name() + table;
    }
