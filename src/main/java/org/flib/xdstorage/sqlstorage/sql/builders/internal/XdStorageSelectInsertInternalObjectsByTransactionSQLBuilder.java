...
public class XdStorageSelectInsertInternalObjectsByTransactionSQLBuilder extends XdStorageAbstractSQLBuilder {
    ...
    private String buildSQLId(final String table) {
        return XdStorageSQLBuilderName.SelectInsertInternalObjectsByTransaction.name() + table;
    }
    ...
    private String build(final XdStorageClassInfo clInfo, final XdStorageClassInfo internalClassInfo, final Class<?> mapKeyClass,
        ...
        sb.append("NULL").append(" FROM ").append(prevStateTable);
