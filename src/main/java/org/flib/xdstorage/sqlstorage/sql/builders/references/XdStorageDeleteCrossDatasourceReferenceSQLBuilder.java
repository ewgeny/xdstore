...
public class XdStorageDeleteCrossDatasourceReferenceSQLBuilder extends XdStorageAbstractSQLBuilder {
    ...
    private String buildSQLId(final String table) {
        return XdStorageSQLBuilderName.DeleteCrossDatasourceReference.name() + table;
    }
