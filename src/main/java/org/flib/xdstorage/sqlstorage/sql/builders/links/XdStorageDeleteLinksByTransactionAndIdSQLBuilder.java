...
public class XdStorageDeleteLinksByTransactionAndIdSQLBuilder extends XdStorageAbstractSQLBuilder {
    ...
    private String buildSQLId(final String table) {
        return XdStorageSQLBuilderName.DeleteLinksByTransactionAndId.name() + table;
    }
    ...
    private String build(final XdStorageClassInfo clInfo, final String table) {
        ...
        sb.append("DELETE FROM ").append(table).append(" WHERE txname = ? AND ");
