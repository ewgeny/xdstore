...
public class XdStorageInsertCrossDatasourceReferenceSQLBuilder extends XdStorageAbstractSQLBuilder {

    @Override
    public String build(Object... values) throws XdStorageException {
    ...
    private String buildSQLId(final String table) {
        return XdStorageSQLBuilderName.InsertCrossDatasourceReference.name() + table;
    }
    ...
    private String build(final XdStorageClassInfo clInfo, final String table) {
        ...
        sb.append(idField.getName()).append(",reference,datasource,txname) VALUES(?,?,?,?)");
