...
public interface IXdStorageSqlPrimaryCriterion {

    String build(XdStorageSQLResourceNamingService namingService, IXdStorageSQLTypesHelper helper,
                  XdStorageClassInfo clInfo, XdStorageSearchIndex index, String fieldsTable, XdStorageObjectField primaryField);
}
