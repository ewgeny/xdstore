...
import org.flib.xdstorage.search.query.*;
...
public class XmlDataFileStorageSearchTest {

    private static final Logger log = LogManager.getLogger(XmlDataFileStorageSearchTest.class);
    ...
    public void test1() {
        ...
        try {
            ...
            IXdStorageCriterion criterionWaterPercent2 =
                    new XdStorageCriterion(XdConstants.WATER_PERCENT_FIELD, IXdStorageCriterionOperator.EQUALS, new Integer(2));
            IXdStoragePrimaryCriterion criterionPlanet8 =
                    new XdStoragePrimaryCriterion(IXdStorageCriterionOperator.EQUALS, "Planet8");
            IXdStorageCriterion criterionWaterPercent1 =
                    new XdStorageCriterion(XdConstants.WATER_PERCENT_FIELD, IXdStorageCriterionOperator.EQUALS, new Integer(1));
            IXdStoragePrimaryCriterion criterionPlanet4 =
                    new XdStoragePrimaryCriterion(IXdStorageCriterionOperator.EQUALS, "Planet4");

            XdStorageSearchQuery query = new XdStorageSearchQuery();
    ...
    public void test2() {
        ...
        IXdStorageTransaction tx = storage.beginTransaction();
        try {
            storage.load(XdPlanet.class, new IXdStoragePredicate<XdPlanet>() {
                @Override
                public boolean passed(XdPlanet object) {
                    object.setName("New name for planet");
                    return false;
                }
            });
            ...
            log.info("error", ex);
            tx.rollback();
        } catch (XdStorageRuntimeException ex) {
            e = ex;
            log.info("error", ex);
        }
    ...
    public void test3() {
        ...
        try {
            storage.load(XdPlanet.class, new IXdStoragePredicate<XdPlanet>() {
                @Override
                public boolean passed(XdPlanet object) {
                    final XdPlanet planet = XdStorageObjectUtils.cloneObject(object);
                    planet.setName("Test");
                    return false;
                }
            });
    ...
    public void test4() {
        ...
        try {
            ...
            IXdStorageCriterion criterion1 =
                    new XdStorageChildCriterion("stars", XdStar.class, XdConstants.NAME_FIELD, IXdStorageChildCriterionOperator.CONTAINS, "Star_4");

            IXdStorageCriterion criterion2 =
                    new XdStorageChildCriterion("stars", XdStar.class, XdConstants.NAME_FIELD, IXdStorageChildCriterionOperator.CONTAINS, "Star_8");
            IXdStorageCriterion criterion3 =
                    new XdStorageChildCriterion("stars", XdStar.class, XdConstants.NAME_FIELD, IXdStorageChildCriterionOperator.CONTAINS, "Star_2");

            IXdStorageCriterion complex = new XdStorageComplexCriterion(criterion2).and(criterion3);
